...
export function tryExtractAccessToken(raw) {
    try {
...
export function normalizeCheckoutOptions(value) {
...
export async function createCheckoutLink(raw, optionsInput) {
    let token;
    let checkoutOptions;
    let payload;
    try {
